...
<html lang="en" dir="ltr" prefix="website: http://ogp.me/ns/website#">
	<head>
		...
		<title>Account history &#8208; <?=SITE_NAME?></title>
		<meta charset="utf-8">
	...
	<body>
		...
		<div class="min-vh-100">
			...
			<div class="container mt-5">
				<h2 class="text-center s-blue">Account history</h2>
		...
		<script type="text/javascript">
			$("#displayData").loaddata({data_url:'<?=SROOT?>includes/fetch-account-history.php', end_record_text:'No data to load'});
		</script>
	</body>
</html>